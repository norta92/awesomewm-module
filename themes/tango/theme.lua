...
local assets_path               = config_path .. "themes/tango/assets/"

local theme = {}

-- Xresources colors
theme.black                     = xres.color0       -- #2e3436
theme.dark_red                  = xres.color1       -- #cc0000
theme.dark_green                = xres.color2       -- #4e9a06
theme.dark_yellow               = xres.color3       -- #edd400
theme.dark_blue                 = xres.color4       -- #3465a4
theme.dark_magenta              = xres.color5       -- #92659a
theme.dark_cyan                 = xres.color6       -- #07c7ca
theme.gray                      = xres.color7       -- #d3d7cf
theme.dark_gray                 = xres.color8       -- #6e706b
theme.red                       = xres.color9       -- #ef2929
theme.green                     = xres.color10      -- #8ae234
theme.yellow                    = xres.color11      -- #fce94f
theme.blue                      = xres.color12      -- #729fcf
theme.magenta                   = xres.color13      -- #c19fbe
theme.cyan                      = xres.color14      -- #63e9e9
theme.white                     = xres.color15      -- #eeeeec
theme.background                = xres.background   -- #2e3436
theme.foreground                = xres.foreground   -- #d3d7cf
...
-- Wallpaper
vars.wallpaper_path             = "/usr/share/backgrounds/archlinux/"
